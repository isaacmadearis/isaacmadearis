...
I am an IT Professional and Cloud & Network Engineering student specializing in infrastructure automation, containerization, and hybrid cloud solutions. 

## 🛠️ Tech Stack & Tools
- **Operating Systems:** Linux (Ubuntu Server), macOS
- **Containerization:** Docker, Portainer, CasaOS
- **Networking & Identity:** Samba SMB, Active Directory, DNS management
- **Cloud Ecosystems:** AWS (EC2, S3, IAM)
